...
| Features | common datagen, mixins, test mod, gametests, common runs. Mod Menu comes with Fabric automatically whenever a build exists for the selected Minecraft version |
